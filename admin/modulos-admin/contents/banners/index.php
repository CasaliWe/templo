...
<section class="w-100 mb-5 pb-4" style="overflow-x: auto;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h6 class="mb-0">Banners Iniciais (Slider)</h6>
        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalBannerInicial">
    ...
    <?php if (count($bannersIniciais) > 0): ?>
        <?php foreach ($bannersIniciais as $index => $bannerInicial): ?>
            <!-- content -->
            <div class="container-banner row py-4 border-top border-bottom">
                <div class="col-2 align-self-center"><?= ($index + 1) ?>-</div>
                <div class="col-3 align-self-center"> 
                    <div class="container-desktop-banner"> 
                        <img src="<?php echo $base_url ?>assets/imagens/arquivos/banners/<?= $bannerInicial['banner_desktop']; ?>"> 
                    </div> 
                </div>
                <div class="col-3 align-self-center"> 
                    <div class="container-mobile-banner"> 
                        <img src="<?php echo $base_url ?>assets/imagens/arquivos/banners/<?= $bannerInicial['banner_mobile']; ?>"> 
                    </div> 
                </div>
                <div class="col-2 align-self-center"> 
                    <a href="../index.php" target="_blank">Ver no site</a> 
                </div>
                <div class="col-2 text-end align-self-center"> 
                    <button class="btn-edit-banner" onclick="if(confirm('Tem certeza que deseja deletar este banner?')) { window.location.href='modulos-admin/contents/banners/php/deletar-banner-inicial.php?id=<?= $bannerInicial['id']; ?>' }">
    ...
    <?php else: ?>
        <div class="container-banner row py-4 border-top border-bottom">
            <div class="col-12 text-center align-self-center text-muted">
                Nenhum banner inicial cadastrado. Clique em "Adicionar Banner" para começar.
            </div>
        </div>
    <?php endif; ?>
</section>
