...
<body>
    ...
    <main id="content-pagina">
        ...
        <?php include_once 'modulos-admin/contents/galeria/index.php';?>
        <!-- módulo content página -->
    </main>
    <!-- CONTENT -->
    ...
    <!-- MODAL ADD GALERIA -->
    <?php include_once "modulos-admin/contents/galeria/modais/add-galeria/index.php"; ?>
    <!-- MODAL ADD GALERIA -->

    <!-- MODAL EDITAR GALERIA -->
    <?php include_once "modulos-admin/contents/galeria/modais/edit-galeria/index.php"; ?>
    <!-- MODAL EDITAR GALERIA -->
